						...
						<div class="post">
							<div class="tilecontainer">
								...
								<a href="{ADMINFOLDER}index.php?page=edit"><div class="tile posttile"><p class="tiletitle">New Post</p></div></a>
								...
								<a href="{ADMINFOLDER}index.php?page=password"><div class="tile passwordtile"><p class="tiletitle">Password</p></div></a>
